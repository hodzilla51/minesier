 ...
 *
 * <p>{@code hops} counts how many times the frame has been forwarded by a switch (built-in or
 * player-built). It is the loop guard: a frame that exceeds {@link #MAX_HOPS} forwards is dropped,
 * so a miswired cable loop can't multiply a frame forever into a broadcast storm.
 */
