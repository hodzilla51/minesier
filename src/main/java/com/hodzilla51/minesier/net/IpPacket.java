 ...
 *
 * <p>Its header follows IPv4 concepts (source, destination, TTL, and protocol) while deliberately
 * omitting checksums, fragmentation, and options from the lossless MVP. The wire format is an
 * internal, string-safe envelope carried in a layer-2 {@link NetworkFrame} payload; it is not an
 * RFC 791 byte encoding.
 */
