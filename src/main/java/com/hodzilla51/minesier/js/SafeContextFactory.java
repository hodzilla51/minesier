...
/**
 * Global Rhino factory enforcing MineSIer's runtime guarantees on every script
 * context: interpreted mode (Knot-classloader-safe) and an instruction budget that
 * aborts runaway code (e.g. {@code while(true){}}) — the anti-runaway half of the
 * "lightweight / no server freeze" requirement, complementing fuel limits.
 */
