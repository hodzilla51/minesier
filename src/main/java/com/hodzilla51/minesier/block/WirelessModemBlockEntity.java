...
/**
 * A wireless antenna attached next to a computer. It carries no state of its own; it just registers
 * its position in {@link WirelessNetwork} while loaded so wireless transmissions can find it
 * without scanning the world. {@code clearRemoved} fires on place/chunk-load and {@code setRemoved}
 * on break/chunk-unload.
 */
