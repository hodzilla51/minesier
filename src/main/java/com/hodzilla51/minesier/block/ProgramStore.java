...
/**
 * A terminal block entity (computer or turtle) whose saved programs live on an
 * inserted disk. The program data belongs to the disk {@link ItemStack} (a data
 * component), so it travels with the disk rather than being tied to this position.
 *
 * <p>Implementors only supply the disk slot + {@link #markChanged}; the program
 * operations are shared defaults that read/write the disk's component.
 */
