...
/**
 * The data a disk holds: named program files. Stored as a data component on the disk {@code
 * ItemStack}, so it travels with the item — the data belongs to the medium, not to any block
 * position.
 */
